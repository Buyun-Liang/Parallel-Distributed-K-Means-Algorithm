...
int main(int argc, char *argv[]){
  ...
  printf("proc name %s myid %d took %f seconds\n", proc_name,myid, endtime-starttime);
  ...
  fclose(fout);
  //printf(" myid %d my filename %s close\n",myid,outfile);
  MPI_Finalize();
  return(0); 
}
